...
3. Read all `scaffold/specs/*.md`, `scaffold/tasks/_log.md`, and `${CLAUDE_PLUGIN_ROOT}/scripts/task.sh status` output. Only plan what is specced and not yet covered by a task.
